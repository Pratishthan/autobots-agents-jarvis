...
# Example: ./run_ui.sh demo 2337
#          ./run_ui.sh nurture 2338
...
DOMAIN_PATH="src/autobots_agents_pay/domains/$DOMAIN"
if [ ! -d "$DOMAIN_PATH" ]; then
    echo "Error: Domain '$DOMAIN' not found at $DOMAIN_PATH"
    echo "Available domains:"
    ls -1 src/autobots_agents_pay/domains/ | grep -v "^__"
    exit 1
fi
